...
Route::middleware('auth')->group(function () {
    ...
    Route::delete('/profile/{id}', [ProfileController::class, 'destroyAccount'])->name('profile.destroyAccount');
});
...
Route::get('/items/filter/{status}/{category}', [AdminDashboard::class, 'filterItems'])
    ->name('items.filter');
